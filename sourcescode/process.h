...
//#define		PROCESS_TIMER_STATE		3
//#define               PROCESS_RUNNING_STATE           4
...
typedef struct pcb1{
        ...
        //struct PageLoadList * pageLoadList;
        void *          ptr_context;
}PCB, * Ptr_PCB;
...
typedef struct PageLoadList{
	//INT32 		PageLoadNum;
	//INT32		VictimIndex;			// points to the next page to be inspected by page replacement algorithm.
	ptr_PLNode 	head;
	ptr_PLNode 	rear;
}PageLoadList;
